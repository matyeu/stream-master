...
export default async function (client: AcClient, interaction: Interaction) {
    ...
    if (interaction.isCommand() && interaction.inGuild()) {
        try {
            ...
            Logger.client(`The ${interaction.commandName} command was used by ${interaction.user.username} on the ${interaction.guild?.name} server`);
        ...
        try {
            ...
            Logger.client(`The ${interaction.customId} select-menu was used by ${interaction.user.username} on the ${interaction.guild?.name} server.`);
